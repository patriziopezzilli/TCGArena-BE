...
public class CardController {
        ...
        @Operation(summary = "Smart Scan Search", description = "Smartly identifies cards from a list of raw OCR text strings")
        @ApiResponses(value = {
        ...
        public Page<CardTemplate> searchCardsAdvanced(
                ...
                Pageable pageable = PageRequest.of(page, size);
                return cardTemplateService.searchCardTemplatesWithFilters(tcgType, expansionId, setCode, rarity, q,
                                pageable);
        }
