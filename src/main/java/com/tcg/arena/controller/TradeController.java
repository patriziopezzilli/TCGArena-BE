...
public class TradeController {
        ...
        // Get trade list for a specific user (public endpoint for viewing other users'
        // lists)
        @GetMapping("/list/{userId}")
        public ResponseEntity<List<com.tcg.arena.dto.TradeListEntryDTO>> getUserList(
                        @PathVariable Long userId,
                        @RequestParam TradeListType type) {
                return ResponseEntity.ok(tradeService.getUserList(userId, type));
        }
